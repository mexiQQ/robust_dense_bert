...
log_file='./logs2/seed-426-lr-2e-5-epoch-30-agnews-freelb-norm_for_each_word_no-dropout'  # training log
...
CUDA_VISIBLE_DEVICES=1 python run_glue_freelb_norm_for_each_word.py \
    --model_name $model \
    --ckpt_dir $cpkt \
